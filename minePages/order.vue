<template>
  <view class="template-order tn-safe-area-inset-bottom">
    <!-- 顶部自定义导航 -->
    <tn-nav-bar fixed customBack :bottomShadow="false" backgroundColor="#1D2541">
    ...
    <view class="top-fixed" :style="{paddingTop: vuex_custom_bar_height + 10 +'px'}" style="background-color:#1D2541;">
      <tn-tabs :list="fixedList" :current="current" :isScroll="false" inactiveColor="#FFFFFF80" activeColor="#FFFFFF" bold="true" backgroundColor="#1D2541" :fontSize="32" :badgeOffset="[20, 50]" @change="tabChange"></tn-tabs>
    </view>
    
    
    <view class="" v-if="current==0" :style="{paddingTop: vuex_custom_bar_height + 60 +'px'}">
      <view v-for="(item,index) in 6" :key="index" class="order__item" @click="tn('/minePages/order-details')">
        ...
        <view class="order__item__content tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex tn-flex-nowrap tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683905799657-assets/web-upload/7e3e822c-e054-4319-9b1f-5db58be0023e.jpeg" mode="aspectFill"></image>
            </view>
            <!-- <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683905799657-assets/web-upload/7e3e822c-e054-4319-9b1f-5db58be0023e.jpeg" mode="aspectFill"></image>
            </view> -->
        ...
        <view class="order__item__operation tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          ...
          <view class="order__item__operation__right tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-right">
            <view class="order__item__operation__right__button">
              <tn-button backgroundColor="#000000" padding="10rpx 18rpx" height="auto" width="100%" :fontSize="22" fontColor="#FFFFFF" shape="round" @click="tn('')">
                再次购买
              </tn-button>
            </view>
          </view>
    ...
    <view class="" v-if="current==1" :style="{paddingTop: vuex_custom_bar_height + 60 +'px'}">
      <view v-for="(item,index) in 6" :key="index" class="order__item" @click="tn('/minePages/order-details')">
        ...
        <view class="order__item__content tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex tn-flex-nowrap tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683907347231-assets/web-upload/0f7ae432-0a19-44fb-ba99-47fe41537f11.jpeg" mode="aspectFill"></image>
            </view>
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683907347081-assets/web-upload/55d51df3-2f84-47d0-9bd9-82e4fbd17b3d.jpeg" mode="aspectFill"></image>
            </view>
            <!-- <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683907347231-assets/web-upload/0f7ae432-0a19-44fb-ba99-47fe41537f11.jpeg" mode="aspectFill"></image>
            </view> -->
    ...
    <view class="" v-if="current==2" :style="{paddingTop: vuex_custom_bar_height + 60 +'px'}">
      <view v-for="(item,index) in 6" :key="index" class="order__item" @click="tn('/minePages/order-details')">
        ...
        <view class="order__item__content tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex tn-flex-nowrap tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683906918806-assets/web-upload/a9f24fd8-3fde-4e96-a0c5-773cb10829b1.jpeg" mode="aspectFill"></image>
            </view>
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683906320444-assets/web-upload/efc56953-c719-46ec-ad24-1f207516ca9d.jpeg" mode="aspectFill"></image>
            </view>
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683905799657-assets/web-upload/7e3e822c-e054-4319-9b1f-5db58be0023e.jpeg" mode="aspectFill"></image>
            </view>
        ...
        <view class="order__item__operation tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          ...
          <view class="order__item__operation__right tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-right">
            <view class="order__item__operation__right__button">
              <tn-button backgroundColor="#000000" padding="10rpx 18rpx" height="auto" width="100%" :fontSize="22" fontColor="#FFFFFF" shape="round" @click="tn('../delivery/delivery')">
                查看物流
              </tn-button>
            </view>
            <view class="order__item__operation__right__button">
    ...
    <view class="" v-if="current==3" :style="{paddingTop: vuex_custom_bar_height + 60 +'px'}">
      <view v-for="(item,index) in 6" :key="index" class="order__item" @click="tn('/minePages/order-details')">
        ...
        <view class="order__item__content tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex tn-flex-nowrap tn-flex-direction-row tn-flex-col-center tn-flex-row-left">
            <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683905940454-assets/web-upload/4a4d5700-d88a-47ab-ab5e-fbbb50609528.jpeg" mode="aspectFill"></image>
            </view>
            <!-- <view class="order__item__content__image">
              <image src="https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683905940454-assets/web-upload/4a4d5700-d88a-47ab-ab5e-fbbb50609528.jpeg" mode="aspectFill"></image>
            </view> -->
    ...
    data() {
      return {
        ...
        swiperList: [{
          ...
          name: '商业合作请联系作者',
          text: '微信：tnkewo',
          url: 'https://cdn.nlark.com/yuque/0/2023/png/280373/1684559753546-assets/web-upload/e65b2ffd-16be-4933-9cd8-0d468a75a116.png',
        }, {
          id: 1,
          type: 'image',
          title: '图鸟南南',
